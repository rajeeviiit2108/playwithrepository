...
public class HomomorphicTechnique {
	...
	public HomomorphicTechnique(int bitLengthVal, int certainty) {
		KeyGeneration(bitLengthVal, certainty);
	}

	public HomomorphicTechnique() {
	...
	public static void main(String[] str) {
		...
		HomomorphicTechnique technique = new HomomorphicTechnique(100,100);
		BigInteger encrypt1 = technique.EncrypStr("1000", new BigInteger("1000"));
		BigInteger encrypt2 = technique.EncrypStr("2000", new BigInteger("2000"));
		System.out.println("data encrypted is::: " + encrypt1);
		String test = technique.DecrpyStr(encrypt1.multiply(encrypt2));

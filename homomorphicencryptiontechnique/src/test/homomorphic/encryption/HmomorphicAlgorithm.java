...
public class HmomorphicAlgorithm
{
    ...
    public HmomorphicAlgorithm(int modLengthIn) throws Exception
    {
        if (modLengthIn < 8)
    ...
    public static void main(String[] args) throws Exception{
    	HmomorphicAlgorithm paillier=new HmomorphicAlgorithm(10);
    	//BigInteger bi1=new BigInteger("500");
    	BigInteger encrypt1=paillier.encrypt(new BigInteger("9"));
    	BigInteger encrypt2=paillier.encrypt(new BigInteger("15"));
    	paillier.printValues();
    	//BigInteger encrypt1=new BigInteger("10");
    //	encrypt=encrypt.add(encrypt1);
    	BigInteger addedBigInteger=encrypt1.add(encrypt2);
    	System.out.println("Encrypted value is::::" +  addedBigInteger);
    	System.out.println("decrypted value is::::" + paillier.decrypt(addedBigInteger));
	}
}